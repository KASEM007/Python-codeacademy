# 1.
# Define a class Student this will be our data model at Jan van Eyck High School
# and Conservatory.
...
# 5.
# Give Grade a constructor for student, declare
# self.grades as an empty list

# 6.
# In the body of constructor for student, declare self.greads as an
# empty list
