...
# key is a last name and the value is a list of first names. For example,
...
#         }
# The function should return a new dictionary where each key is
# the first letter of a last name, and the value is the number
