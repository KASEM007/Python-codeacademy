...
##  Looking at the signature of main() we define four
##  different kinds of parameters. The first, filename
##  is a normal required positional parameter.
##  The second,
##  *args, is all positional arguments given to a function after
##  that organized as a tuple in the parameter args. The third,
##  user_list, is a keyword parameter with a default value. Lastly,
##  **kwargs is all other keyword arguments assembled as a dictionary
##  in the parameter kwargs.
...
## We can use all four of these kinds of parameters to create
## functions that handle a lot of possible arguments being passed to them.
