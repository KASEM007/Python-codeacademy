...
# 1- Write a function called f_to_c that takes an input f_temp,
# a temperature in Fahrenheit, and converts it to c_temp,
# that temperature in Celsius. It should then return c_temp.
# The equation you should use is:

# Temp (C) = (Temp (F) - 32) * 5/9

# Let’s test your function with a value of 100 Fahrenheit.
# Define a variable f100_in_celsius and set it equal to the
# value of f_to_c with 100 as an input.

# Write a function called c_to_f that takes an input c_temp,
# a temperature in Celsius, and converts it to f_temp, that
...
# Define a variable c0_in_fahrenheit and set it equal to the
# value of c_to_f with 0 as an input.
...
# 7.
# Print the string “The GE train supplies X Newtons of force.”,
