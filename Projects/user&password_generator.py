...
# 1- Copeland’s Corporate Company has finalized what they want to their username and temporary password
...
# first_name and last_name and returns a username. The username should be a slice of the first three
# letters of their first name and the first four letters of their last name. If their first name is
# less than three letters or their last name is less than four letters it should use their entire names.
...
# 3- Inside password_generator create a for loop that iterates through the indices username by going
# from 0 to len(username).
# To shift the letters right, at each letter the for loop should add the previous letter to the
# string password.
